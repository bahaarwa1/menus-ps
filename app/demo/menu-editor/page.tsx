...
export default function MenuEditorPage() {
  ...
  return (
    <div className="space-y-4 max-w-7xl mx-auto pb-10 font-sans text-slate-800" dir="rtl">
      ...
      {/* Header Bar */}
      <div className="bg-white border border-slate-200/80 rounded-2xl p-3.5 sm:p-4 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-3">
        <div>
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 sm:w-10 sm:h-10 bg-orange-50 text-orange-600 rounded-xl flex items-center justify-center font-bold shrink-0">
              <UtensilsCrossed className="w-5 h-5 sm:w-5.5 sm:h-5.5" />
            </div>
            <div>
              <h1 className="text-base sm:text-xl font-black text-slate-900">تعديل وإدارة قائمة الطعام (المنيو)</h1>
              <p className="text-[11px] sm:text-xs text-slate-400">إضافة أطباق جديدة، تعديل الأسعار، وتحديد الأصناف المتوفرة فورياً</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={() => openModal()}
            className="flex-1 sm:flex-initial px-3.5 sm:px-4 py-2 sm:py-2.5 bg-orange-500 hover:bg-orange-600 active:scale-95 text-white rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 shadow-md shadow-orange-500/20 transition-all"
          >
            <Plus size={16} />
          ...
          <button
            ...
            className="p-2 sm:p-2.5 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded-xl text-xs font-bold transition-colors"
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 w-full max-w-lg shadow-2xl z-10 border border-slate-100 max-h-[90vh] overflow-y-auto text-right"
            >
              <div className="flex justify-between items-center pb-3 mb-3 sm:mb-4 border-b border-slate-100">
              ...
              <form onSubmit={handleSaveItem} className="space-y-3 sm:space-y-3.5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs focus:ring-2 focus:ring-orange-500 focus:bg-white text-slate-800"
                  />
                </div>
