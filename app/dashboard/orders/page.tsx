  ...
  const [orders, setOrders] = useState<Order[]>([
    {
      ...
      total: 98,
      createdAt: 'منذ دقيقة',
      notes: 'بدون بصل لو سمحتوا، وزيادة صوص حار',
      items: [
        { name: 'برجر كلاسيك بيف', qty: 2, price: 35, extras: ['جبنة إضافية', 'مخلل'] },
        { name: 'بطاطا مقلية كريسبي', qty: 1, price: 14 },
        { name: 'كوكا كولا زيرو', qty: 2, price: 7 },
      ],
    },
    {
      id: 'ORD-103',
      ...
      items: [
        { name: 'بيتزا مارجريتا حجم وسط', qty: 1, price: 45 },
        { name: 'بطاطا ودجز متبلة', qty: 1, price: 20 },
      ],
    },
    {
      id: 'ORD-102',
      ...
      notes: 'الرجاء إحضار شوك ومحارم إضافية',
      items: [
        { name: 'ساندويش شاورما دجاج سوبر', qty: 3, price: 22 },
        { name: 'عصير برتقال طبيعي طازج', qty: 3, price: 6 },
      ],
    },
    {
      id: 'ORD-101',
      ...
      items: [
        { name: 'باستا ألفريدو دجاج فطر', qty: 1, price: 42 },
      ],
    },
  ]);

  const advanceOrderStatus = (orderId: string, currentStatus: Order['status']) => {
    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-12 font-sans text-slate-900" dir="rtl">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-4 border-b border-slate-200">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">استقبال وتحديث طلبات الزبائن مباشرة من الطاولات</p>
        </div>
        ...
        {filteredOrders.map((order) => (
          ...
          >
            ...
            <div className="pt-3 border-t border-slate-100 flex items-center gap-2">
              {order.status === 'new' && (
                <button
                  onClick={() => advanceOrderStatus(order.id, 'new')}
